...
CREATE TABLE `t_shop` (
  ...
  `credit_not` geometry NOT NULL,
  `credit_visa` geometry NOT NULL,
  `credit_mastercard` geometry NOT NULL,
  `credit_jcb` geometry NOT NULL,
  `credit_unionpay` geometry NOT NULL,
